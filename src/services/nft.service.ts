...
class NftService {
  ...
  async getRawDataIsNotNullOfNfts(limit = 10) {
    const service = await this.getRepository();
    return await service
      .createQueryBuilder()
