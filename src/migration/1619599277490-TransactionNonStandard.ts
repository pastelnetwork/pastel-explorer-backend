...
export class TransactionNonStandard1619599277490 implements MigrationInterface {
  name = 'TransactionNonStandard1619599277490';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "Transaction" ("id" varchar(64) PRIMARY KEY NOT NULL, "timestamp" integer NOT NULL, "coinbase" integer, "totalAmount" integer NOT NULL, "recipientCount" integer NOT NULL, "blockHash" varchar NOT NULL, "rawData" varchar NOT NULL, CONSTRAINT "FK_3c25c62421fb7a3037e333dc128" FOREIGN KEY ("blockHash") REFERENCES "Block" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`,
    );
    await queryRunner.query(
